...
MODEL                = template_linear
MODULES              = rtGetInf.c rtGetNaN.c rt_nonfinite.c template_linear_data.c template_linear_main.c 
MAKEFILE             = template_linear.mk
...
S_FUNCTIONS          = 
S_FUNCTIONS_LIB      = C:\ARQUIV~1\Quanser\QUARC\lib\windows\hil.lib C:\ARQUIV~1\Quanser\QUARC\lib\windows\QU2F51~1.LIB C:\ARQUIV~1\Quanser\QUARC\lib\windows\QUCE95~1.LIB
SOLVER               = ode1.c
NUMST                = 2
TID01EQ              = 1
NCSTATES             = 1
COMPUTER             = PCWIN
BUILDARGS            =  GENERATE_REPORT=0 MAT_FILE=0 DEBUG=0 DEBUG_HEAP=0
MULTITASKING         = 0
EXT_MODE             = 1
...
MODELLIB                  = template_linearlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = template_linear_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);C:\DOCUME~1\Aluno\MEUSDO~1\MATLAB\TEMPLA~1
MATLAB_INCLUDES = $(MATLAB_INCLUDES);C:\DOCUME~1\Aluno\MEUSDO~1\MATLAB
MATLAB_INCLUDES = $(MATLAB_INCLUDES);C:\DOCUME~1\Aluno\Desktop
MATLAB_INCLUDES = $(MATLAB_INCLUDES);C:\ARQUIV~1\Quanser\QUARC\include
